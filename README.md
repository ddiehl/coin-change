...
The idea of this exercise is to implement a Spring Boot Rest application able to provide change given an input dollar bill.

\* Feel free to use any Gen AI tool.
